  ...
  <div class="articaldetail">
    ...
    <div class="detail">
      ...
      <video
        ...
        controls
        v-else
        poster="https://ss2.bdstatic.com/70cFvnSh_Q1YnxGkpoWK1HF6hhy/it/u=3681880960,455182084&fm=26&gp=0.jpg"
      ></video>
      <div class="opt">
        <span class="like" :class="{ active: post.has_like }" @click="putLike">
          <van-icon name="good-job-o" />{{
            post.has_like ? post.comment_length : "点赞"
          }}
        </span>
...
export default {
  ...
  methods: {
    ...
    // 点赞
    async putLike() {
      let res = await postLike(this.post.id);
